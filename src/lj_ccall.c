...
/* -- RISCV64 ABI struct classification ------------------------------------- */
...
#elif LJ_TARGET_ARM64 || (LJ_TARGET_MIPS64 && !LJ_ABI_SOFTFP) || LJ_TARGET_RISCV64
