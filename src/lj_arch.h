...
#elif LUAJIT_TARGET == LUAJIT_ARCH_RISCV32 ||  LUAJIT_TARGET == LUAJIT_ARCH_RISCV64
...
#if LUAJIT_TARGET == LUAJIT_ARCH_RISCV32
#define LJ_TARGET_RISCV32	1
#define LJ_ARCH_NAME		"riscv32"
#else
...
#if LJ_ABI_SOFTFP
#error "Only RISCV64 HF supported for now"
#endif
#if defined(__riscv_compressed)
#error "Compressed instructions not supported for now"
#endif
