  ...
  for (secnum = 0; secnum < D->maxsection; secnum++) {
	...
	patchrel:
	  if (val & 2048) { /* B */
	    ...
	    cp[-1] |= ((n << 7) & 0x0f00) | ((n << 20) & 0x7e000000)
		| ((n >> 4) & 0x80) | ((n << 19) & 0x80000000);
	  } else { /* J */
	    CK((n & 1) == 0 && ((n+0x00100000) >> 21) == 0, RANGE_REL);
	    cp[-1] |= ((n << 20) & 0x7fe00000) | ((n << 9) & 0x100000)
